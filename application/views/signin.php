...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url().'vendor/twbs/bootstrap/dist/css/bootstrap.css'?>"></link>
    <link rel="stylesheet" href="<?php echo HTML::style("style/signin")?>" id="maincss" />
    <!-- Script js -->
